...
namespace RaidCrawler.Tests
{
    public class TestUtil
    {
        ...
        public ((int, int),  RaidContainer?) GetRaidContainer(string path, int storyPrg)
        {
            ...
            (int deliverry,  int encounter) = container.ReadAllRaids(baseData, storyPrg, eventPrg, 0, PKHeX.Core.TeraRaidMapParent.Paldea);
            var failed = (deliverry, encounter);
